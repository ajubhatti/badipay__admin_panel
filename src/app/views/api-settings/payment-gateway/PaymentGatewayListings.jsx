...
import { deletePaymentGateways, getPaymentGatewayList } from "./store/action"
import {
  AiOutlineEdit,
  AiFillDelete,
  AiFillEye,
...
import AddUpdatePaymentGatewayModal from "./AddUpdatePaymentGatewayModal"

const PaymentGatewayListings = () => {
  ...
  const handleOk = async () => {
    dispatch(
      deletePaymentGateways(apiData._id, () => {
    ...
    <div className="container-fluid w-100 mt-3">
      <div className="row">
        <div className="col-lg-12 justify-content-between d-flex">
          <h6 className="main-heading">Payment Gateway List</h6>
          <button
...
export default PaymentGatewayListings
