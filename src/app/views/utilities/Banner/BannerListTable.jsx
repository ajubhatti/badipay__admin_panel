        ...
        <StyledTable>
          ...
          <TableBody>
            {bannerList
              ...
              .map((banner, index) => (
                <TableRow key={index}>
                  <TableCell align="left">{ShowImage(banner?.path)}</TableCell>
                  <TableCell align="left">{banner?.fileName}</TableCell>
                  <TableCell align="left">{banner?.description}</TableCell>
                  <TableCell align="left">
                    {moment(banner?.created).format("MMMM Do YYYY, h:mm:ss")}
                  </TableCell>
                  ...
                  <TableCell>
                    <IconButton onClick={() => changeStatus(banner)}>
                      <Icon
                        color={`${!banner?.isActive ? "primary" : "error"}`}
                      >
                        {banner?.isActive ? "close" : "check"}
                      </Icon>
                    </IconButton>
                    ...
                    <IconButton onClick={() => deleteBanner(banner)}>
